...
function ModuleOverview({ transactionData }: any) {
    ...
    useEffect(() => {
        if (transactionData != undefined) {
            ...
            const calculatedFee = getFee(transactionData?.transactionInfo?.actualGasCost, transactionData?.network);
                ...
                <Paper sx={{ p: 3 }}>
                    ...
                    {transactionData != undefined && (
                        <>
                            <SmartRow
                                ...
                                action={<CopyButton text={data?.moduleTransactionId?.split(",")?.[0]} setOpen={setOpen} />}
                            >
                            ...
                            <SmartRow
                                ...
                                action={
                                    <>
                                        ...
                                        <RedirectButton redirectLink={`/wallet?safe=${data?.safe}&network=${network}`} />
                                    </>
                                }
                            >
                                <Typography fontWeight="medium" noWrap fontFamily="'DM Mono'">
					...
					>
						<Typography fontWeight="medium">{data?.data}</Typography>
                            ...
                            >
                                <Typography fontWeight="medium">{data?.submissionDate ? data?.submissionDate : "-"}</Typography>
                            </SmartRow>
                            <SmartRow
                                label={{
                            ...
                            <SmartRow
                                label={{
                                    ...
                                    text: (
                                        <Typography color="text.secondary" textTransform="capitalize" fontFamily="'DM Mono'">
                                            Data
                                        </Typography>
                                    ),
                                    info: "null",
