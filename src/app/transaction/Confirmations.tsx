...
function Confirmations({ transactionData }: any) {
    ...
    useEffect(() => {
        if (transactionData != undefined) {
            ...
            setNetwork(net);
            setConfirmations(transactionData[net].confirmations);
        }
    }, [transactionData]);
    ...
    return (
        <Paper sx={{ p: 3 }}>
                ...
                action={
                    <IconButton onClick={() => handleCollapse("successful-signatures")}>
                        <KeyboardArrowUpIcon
                            sx={{
                                fontSize: 20,
                                transform: collapse === "successful-signatures" ? "rotate(-180deg)" : "",
            ...
            >
                <Typography fontFamily="'DM Mono'" fontWeight="medium" noWrap>
                    {confirmations?.length} successful signature{confirmations?.length > 1 ? "s" : ""}
                </Typography>
            </SmartRow>
                            ...
                            <SmartRow
                                action={
                                    confirmation.transactionHash && (
                                        <Button href={NETWORK_SCANNER_MAP[network] + "/tx/" + confirmation.transactionHash} size="small">
                                            View Hash
                                        </Button>
                                    )
                                }
                                ...
                                <Stack direction="row" spacing={4} alignItems="center">
                                    ...
                                    <Stack direction="row" alignItems="center" spacing={1}>
                                        ...
                                        <Typography fontFamily="'DM Mono'">
                                            {timeAgo.format(new Date(confirmation.submissionDate))} ({confirmation.submissionDate})
                                        </Typography>
                                    </Stack>
                                </Stack>
                            </SmartRow>
