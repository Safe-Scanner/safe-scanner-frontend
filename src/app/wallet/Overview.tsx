          ...
          <SmartRow
            ...
            action={
              <>
                ...
                <RedirectButton
                  redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${data?.fallbackHandler}`}
                />
              </>
            }
          >
          ...
          <SmartRow
            ...
            action={
              <>
                ...
                <RedirectButton
                  redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${data?.masterCopy}`}
                />
              </>
            }
          >
                ...
                <>
                  ...
                  {data?.guard &&
                    data?.guard !=
                      ...
                      <RedirectButton
                        redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${data?.guard}`}
                      />
                    )}
                </>
              }
                ...
                <SmartRow
                  action={
                    <>
                      ...
                      <RedirectButton
                        redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${el}`}
                      />
                    </>
                  }
                  key={index}
