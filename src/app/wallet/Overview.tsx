...
import { NETWORK_ICON_MAP, NETWORK_MAP } from "@/constants/constants";
        ...
        <>
            {balance != undefined && Object.keys(data).length > 0 ? (
                <Paper sx={{ p: 3 }}>
                        ...
                        <SmartRow
                            ...
                            action={
                                <>
                                    ...
                                    <RedirectButton
                                        redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\tx\\${data?.creationData?.transactionHash}`}
                                    />
                                </>
                            }
                        >
                            <Typography fontFamily="'DM Mono'" color="primary" textTransform="capitalize">
                                {data?.creationData?.transactionHash}
                            </Typography>
                        </SmartRow>
                    )}
                    <SmartRow
                        ...
                        action={
							...
							<ContentCopyIcon color="primary" sx={{ fontSize: 20 }} />
                                ...
                                <RedirectButton redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${data?.fallbackHandler}`} />
                            </>
                        }
                    >
                        <Typography fontFamily="'DM Mono'" color="primary" textTransform="capitalize">
                    ...
                    <SmartRow
                        ...
                        action={
                            <>
                                ...
                                <RedirectButton redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${data?.masterCopy}`} />
                            </>
                        }
                    >
                        <Typography fontFamily="'DM Mono'" color="primary" textTransform="capitalize">
                        ...
                        <SmartRow
                            ...
                            action={
                                <>
                                    ...
                                    {data?.guard && data?.guard != "0x0000000000000000000000000000000000000000" && (
                                        <RedirectButton redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${data?.guard}`} />
                                    )}
                                </>
                            }
                        >
                    ...
                    <SmartRow
                        label={{
                            icon: <Image src="images/LabelIconquestion.svg" alt="" width={30} height={30} />,
                            text: (
                                <Typography color="text.secondary" textTransform="capitalize">
                                    Nounce
                                </Typography>
                    ...
                    >
                        <Typography fontWeight="medium">{data?.nonce} transactions done</Typography>
                    </SmartRow>
                    ...
                    >
                        <Typography fontWeight="medium" noWrap>
                            {data?.owners?.length} owners ({data?.threshold} signatures required for confirming transactions)
                        </Typography>
                    </SmartRow>
                                ...
                                <SmartRow
                                    action={
                                        <>
                                            ...
                                            <RedirectButton redirectLink={`${NETWORK_MAP[network]?.explorerUrl}\\address\\${el}`} />
                                        </>
                                    }
                                    key={index}
                                >
